...
* **container:** Update uv (0.11.26 → 0.12.3) ([#42](https://github.com/alex-matthews/costanza/issues/42))
...
* adopt home-operations port convention (main 8080, metrics 8081) ([#27](https://github.com/alex-matthews/costanza/issues/27)) ([cc2ff53](https://github.com/alex-matthews/costanza/commit/cc2ff534697cc3a0f6cd15cb7c77eb5a9e94dab8))
...
* **container:** Update uv (0.11.26 → 0.12.3) ([#42](https://github.com/alex-matthews/costanza/issues/42)) ([dc5000f](https://github.com/alex-matthews/costanza/commit/dc5000f72ab73a3c14e4befce857e0bb1f55d07b))
...
* **container:** update image ghcr.io/astral-sh/uv (0.12.18 → 0.12.19) ([#52](https://github.com/alex-matthews/costanza/issues/52)) ([d5b4e81](https://github.com/alex-matthews/costanza/commit/d5b4e819f4d83389833445400fa73cb04e526c54))
* **container:** update python ([#43](https://github.com/alex-matthews/costanza/issues/43)) ([9a1d7be](https://github.com/alex-matthews/costanza/commit/9a1d7be0e9e715ca80222bfc3117b3b841111613))
* **container:** update uv ([#46](https://github.com/alex-matthews/costanza/issues/46)) ([59bb503](https://github.com/alex-matthews/costanza/commit/59bb5033c8260c72d10778fcdce1cc08b583f158))
* **container:** update uv (0.11.24 → 0.11.26) ([#20](https://github.com/alex-matthews/costanza/issues/20)) ([a77f82d](https://github.com/alex-matthews/costanza/commit/a77f82da53196654e3fbfed5b8840def8021711f))
* **docker:** image default port 8140 -&gt; 8080 (+ EXPOSE 8081 metrics) ([#28](https://github.com/alex-matthews/costanza/issues/28)) ([5f0bd71](https://github.com/alex-matthews/costanza/commit/5f0bd71bc57878fdf72d131009ae9db8277e0a19))
...
* **adr:** ADR-0011 — downgrade execution (council decides, Resolute executes) ([#26](https://github.com/alex-matthews/costanza/issues/26)) ([7ac59f7](https://github.com/alex-matthews/costanza/commit/7ac59f7be140bde9a8fc93ae999244e57c31064a))
* **adr:** amend ADR-0011 — objective read is model-derived (Resolute ADR-0003) ([#44](https://github.com/alex-matthews/costanza/issues/44)) ([9f35add](https://github.com/alex-matthews/costanza/commit/9f35add05581551852eaa5e5f8dfec7aaa8924ea))
...
* reflect ADR-0011 (downgrade executes via Resolute) + 8081 metrics ([#30](https://github.com/alex-matthews/costanza/issues/30)) ([9a952b1](https://github.com/alex-matthews/costanza/commit/9a952b14d2a20830928bd86df10c0b090a218019))
